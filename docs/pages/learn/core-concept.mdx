...
>
> If you don't want to implement state and interaction logic yourself, you can use the '[Krmx State](/state)' to handle state managament for you. Krmx State tackles common functionality such as state management, optimistic updates, and more.
