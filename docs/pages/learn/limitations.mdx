...
Krmx does not include a default state management implementation out of the box. However, users can refer to [Krmx State](/state) documentation, which offers three state management models for Krmx-powered applications.
