...
The Krmx API on server and client side abstract away this complexity and allows the developer to consume a simple event-based API. The [application lifetime](application-lifetime) describes these events in more detail.
