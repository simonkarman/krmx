...
## NodeJS Installation
These steps help you to add Krmx to an already existing NodeJS TypeScript backend server and a TypeScript React frontend. If start from scratch you can follow the [demo from scratch](getting-started/demo).
